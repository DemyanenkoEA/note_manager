...
while True:
    ...
    print("Текущий статус заметки: ", note_statuses[note['status']])
    ...
    if change_status == 'да' or change_status == '1':
        ...
        while True:
            ...
            if variant in note_statuses.keys():
                ...
                note['status'] = variant
                break
            # Если ключа нету либо неправильный ввод
            else:
                print('ОШИБКА: Вы указали неправильный вариант статуса заметки!\n Для повтора нажмите > Enter')
                input()
    # Если пользователь ввел "нет" или 0
    elif change_status == "нет" or change_status == '0':
